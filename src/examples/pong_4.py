...
Full example from pong tutorial.
Ball moves a bit slow, and does not bounce if it hits the upper/lower borders.
But otherwise, left paddle responds to player input, right paddle is ai controlled, ball bounces and has some physics.
"""
